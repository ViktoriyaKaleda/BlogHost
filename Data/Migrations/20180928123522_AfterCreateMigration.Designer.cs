...
namespace BlogHosting.Data.Migrations
{
    ...
    [Migration("20180928123522_AfterCreateMigration")]
    partial class AfterCreateMigration
    {
            ...
            modelBuilder.Entity("BlogH.Models.Comment", b =>
                {
                    ...
                    b.Property<int?>("ChildCommentCommentId");
                    ...
                    b.HasIndex("ChildCommentCommentId");
            ...
            modelBuilder.Entity("BlogH.Models.Comment", b =>
                {
                    ...
                    b.HasOne("BlogH.Models.Comment", "ChildComment")
                        .WithMany()
                        .HasForeignKey("ChildCommentCommentId");
